...
$resource_file = 'UseCaseXsFromYCommand.tpl';

if( $argc != 4){
    echo "Usage:\n";
    echo "php tools/makeUseCasesXsFromYCommand.php UseCase EntityX EntityY\n";
    exit(1);
}
...
$destination = 'src' . namespace2dir($next) . '/' . $UseCase . $EntityX . 'sFrom' . $EntityY . 'Command.php';
