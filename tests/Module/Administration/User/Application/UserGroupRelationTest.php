...
class UserGroupRelationTest extends TestCase
{
    public function setUp(): void
    {
        ...
        app()->bind('Joselfonseca\LaravelTactician\CommandBusInterface',
            new \ProyectoTAU\Tests\Integration\CommandBus\CommandBusExt(
                new \ProyectoTAU\Tests\Integration\CommandBus\Locator\HandlerLocator()
            ));
        ...
        /*app()->bind('ProyectoTAU\TAU\Module\Administration\User\Application\addGroupToUser\AddGroupToUserCommandHandler',
                   new ProyectoTAU\TAU\Module\Administration\User\Application\addGroupToUser\AddGroupToUserCommandHandler(
                            app('ProyectoTAU\TAU\Module\Administration\Group\Domain\GroupRepository'),
                            app('ProyectoTAU\TAU\Module\Administration\User\Domain\UserRepository')
                   ) );
        */
    }
